...
// primary config:
const title = ApplicationConfig.siteTitle || ApplicationConfig.siteName; // 'Aurelia Navigation Skeleton';
const description = ApplicationConfig.siteDescription || null; // from old config
